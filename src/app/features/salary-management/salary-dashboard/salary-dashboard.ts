...
export class SalaryDashboard {
private chart!: Chart;

  constructor(private zone: NgZone) {}

  ngAfterViewInit(): void {
    // dùng NgZone để đảm bảo Chart render sau khi Angular vẽ DOM xong
    this.zone.runOutsideAngular(() => {
      // Đợi DOM ổn định hẳn, tránh lỗi kích thước 0
  ...
  private initChart(): void {
    ...
    // Nếu chart cũ tồn tại (khi reload component), thì destroy trước
